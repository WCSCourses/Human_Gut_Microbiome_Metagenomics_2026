...
In this practical exercise, participants use pre-generated QC report from the metaWRAP to understand how you evaluate evaluate sequencing quality for downstream metagenomic analysis.\
...
## **Exercise: Evaluate raw sequencing quality**

From the metaWRAP QC output, download the SRR30598619_multiqc_report.html file to your local machine and open it in a web browser.
